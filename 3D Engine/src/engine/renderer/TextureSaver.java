...
public class TextureSaver {
	...
	/*public static void saveBufferDepthTexture(FrameBuffer framebuffer, int width, int height, String filePath, String format) throws IOException{
		framebuffer.bindFrameBuffer();
		int bpp = 4;
		FloatBuffer buffer = BufferUtils.create
		GL11.glReadPixels(0, 0, width, height, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, buffer);
